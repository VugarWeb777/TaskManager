...
const boardFilterTemplate = function () {
...
const loadMoreTemplate = function () {
...
const boardTaskContainer = createElement(`div`, `board__tasks`);


renderTemplate(menuContainer.querySelector(`.main__control`), menuTemplate());
renderTemplate(menuContainer, searchTemplate());
renderTemplate(menuContainer, filterTemplate());
renderTemplate(menuContainer, boardContainer.outerHTML);
